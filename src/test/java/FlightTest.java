...
public class FlightTest {
    ...
    public void canBookIntoFlight(){
        myFlight.bookInPassenger(neil);
        assertEquals(1,myFlight.getPassengerCount());
    }

    @Test
    public void getAvailableSeats(){
        smallFlight.bookInPassenger(neil);
    ...
    public void getAvailableSeatsPlaneFull(){
        smallFlight.bookInPassenger(neil);
        smallFlight.bookInPassenger(vicki);
    ...
    public void tooManyForFlight(){
        smallFlight.bookInPassenger(neil);
        smallFlight.bookInPassenger(lucy);
        smallFlight.bookInPassenger(vicki);
        assertEquals(2,smallFlight.getPassengerCount());
    }

    @Test public void getBaggageWeightForFlight(){
        assertEquals(225.00,myFlight.flightBaggageWeightPerPerson());
    }
}
